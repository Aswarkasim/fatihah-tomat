...
class HomeDiagnosaController extends Controller
{
    //
    ...
    function createPasien(Request $request)
    {
        ...
        return redirect('/home/diagnosa/periksa');
    }
    ...
    function proses()
    {
        ...
        $pasien->save();
        return redirect('/home/diagnosa/result');
    }
